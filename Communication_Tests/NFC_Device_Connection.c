/***************************************************************************
    NFC Device Connection.c
    Author: Meghadoot
    2025-03-06
    
    This is a library for the validation of NFC.
    This validation test uses libnfc and nfc-tools to conenct to NFC tags.
...
int main() {
    printf("Starting NFC Connection Establishment Test...\n");

    // Attempt to detect & connect to NFC tag
    system("nfc-poll -1");

    printf("NFC Connection Establishment Test completed.\n");
    return 0;
}
